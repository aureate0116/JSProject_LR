...
function getFoundationTabResources() {
  axios.get('./json/db.json').then(function (res) {
    ...
    console.log("\u8CC7\u6599\u6709\u8AA4"); //console.log(error.response.data);
  });
} //3. 渲染入門推薦資料
...
!function (e, t) {
  ...
  var $ = function $(e, t, n, r, i, o, a) {
    ...
    if ("object" === T(n)) for (s in i = !0, n) {
      $(e, t, s, n[s], !0, o, a);
    } else if (void 0 !== r && (i = !0, b(r) || (a = !0), l && (a ? (t.call(e, r), t = null) : (l = t, t = function t(e, _t2, n) {
      return l.call(E(e), n);
    })), t)) for (; s < u; s++) {
...
!function (t, e) {
  ...
  P.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", Z.dataApiClickHandler), P.on(window, "load.bs.carousel.data-api", function () {
    ...
    for (var _t6 = 0, _i4 = e.length; _t6 < _i4; _t6++) {
        ...
        for (var _t9 = 0, _n5 = i.length; _t9 < _n5; _t9++) {
          ...
          if (e) {
            var _t10 = e.composedPath(),
                _i9 = _t10.includes(_n6._menu);

            if (_t10.includes(_n6._element) || "inside" === _n6._config.autoClose && !_i9 || "outside" === _n6._config.autoClose && _i9) continue;
  ...
  function Re(t, e, i) {
    ...
    var _loop = function _loop(_t13, _i10) {
      var _ref8;
    ...
    for (var _t13 = 0, _i10 = o.length; _t13 < _i10; _t13++) {
      var _ret = _loop(_t13, _i10);
